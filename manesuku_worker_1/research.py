...
対象: {asset} の株価。期間: {entry} 〜 2026-06（現在）。

次を**実数**で集めてください（すべて分割・配当調整後＝split/dividend adjusted で統一）:
1) 転換点の株価アンカー（各年＋大きく動いた主要月）。最低でも {entry} と 2026-06 を含む。
2) 現在(2026-06)の株価。
